...
AT_BACKUP_GRADLE="$HOME/.pub-cache/hosted/pub.dev/at_backupkey_flutter-4.1.0/android/build.gradle"
...
AT_ONBOARDING_GRADLE="$HOME/.pub-cache/hosted/pub.dev/at_onboarding_flutter-6.2.0/android/build.gradle"
...
AT_ONBOARDING_PLUGIN="$HOME/.pub-cache/hosted/pub.dev/at_onboarding_flutter-6.2.0/android/src/main/kotlin/com/atsign/at_onboarding_flutter/AtOnboardingFlutterPlugin.kt"
